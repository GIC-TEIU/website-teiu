      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 max-w-[520px]">
          ...
          <form className="mt-8 flex flex-col gap-4">
            ...
            <button
              type="button"
              className="mt-3 flex cursor-pointer items-center justify-between bg-[#E0F896] hover:opacity-90 transition px-6 py-3 rounded-full font-medium text-gray-900 shadow-sm"
            >
              ENVIAR MENSAGEM
